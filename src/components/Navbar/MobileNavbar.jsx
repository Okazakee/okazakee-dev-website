...
export const MobileNavbar = ({SetPageName, isMobile}) => { /* //TODO ADD SWIPE GESTURES TO CHAGNE PAGE */
    ...
    const NavbarStyle = `bg-[#8c54fb] fixed bottom-6 left-0 right-0 z-50 rounded-2xl text-sm text-center w-[90vw] h-[4rem] mx-auto pt-3`;
    const defaultBtnStyle = 'nav h-fit text-[#e8e8e8]';
    const selectedBtnStyle = 'nav underline underline-offset-1 h-fit text-[#090909]';
    const iconStyle = 'h-7 w-7 relative mx-auto';
    ...
    return (
        ...
        :
        <div className={NavbarStyle}> {/* //TODO FIX TEXT UNDERLINE BEHAVIOUR, FIND A WAY TO TRAT BUTTON AS UNIQUE PIECE, HIDE WHEN DOWNSCROLLING */}
